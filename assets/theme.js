...
['mouseover', 'click'].forEach(evtType => {
  ...
  theme.Photoswipe = (function() {
    var selectors = {
      ...
      slideshowTrack: '.swiper ',
      activeImage: '.swiper-slide-active'
    };
    ...
    Photoswipe.prototype = Object.assign({}, Photoswipe.prototype, {
      init: function() {
        !theme.swiper || theme.swiper.slides.forEach((slide) =>
          slide.addEventListener('click', (e) =>
          {
            if (this.id === theme.current_photoswipe.id)
            {
              e.stopPropagation();
              this.triggerClick();
            }
      ...
      triggerClick: function(evt) {
        ...
        this.initGallery(this.items, theme.swiper.activeIndex);
      },
    ...
    Photoswipe.prototype.getGallery = () => this.gallery;
  ...
  theme.Product = (function() {
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      initImageZoom: function() {
        ...
        theme.current_photoswipe = new theme.Photoswipe(container, this.sectionId);
        ...
        container.addEventListener('photoswipe:afterChange', function(evt) {
          ...
          !theme.swiper || theme.swiper.slideTo(evt.detail.index, 500);
        }.bind(this));
      },
  ...
  const hasImageSet = variant.featured_media.alt && variant.featured_media.alt.indexOf('#') > -1;
  
  if (hasImageSet && this.settings.imageSetName) {
    const hashIndex = variant.featured_media.alt.indexOf('#');
    const current_group = variant.featured_media.alt.substring(hashIndex + 1);
    ...
    const selector = '[data-media-id="' + mediaId + '"]';
    const targetSlide = this.cache.mainSlider.querySelector(selector);
  ...
  this.initImageZoom();
      ...
      initProductSlider: function(variant) {
        ...
        !theme.swiper || theme.swiper.destroy();
      ...
      onSliderInit: function(slide) {
        ...
        if (this.settings.imageSetName) {
          this.prepMediaOnSlide(slide.el);
        }
      },
